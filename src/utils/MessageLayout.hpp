...
class MessageLayout {
 public:
  ...
  // }
  inline virtual MessageEnums::Type getEnum() = 0;
...
class EmptyMessageLayout : public MessageLayout {
 public:
  inline MessageEnums::Type getEnum() override { return MessageEnums::Type::EMPTY; }
  inline void print() override { printf("Empty Message...\n"); }
...
class TestMessageLayout : public MessageLayout {
 public:
  inline MessageEnums::Type getEnum() override { return MessageEnums::Type::TEST; }
